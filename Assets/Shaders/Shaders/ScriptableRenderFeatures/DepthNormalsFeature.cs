...
public class DepthNormalsFeature : ScriptableRendererFeature
{
    class DepthNormalsPass : ScriptableRenderPass
    {
        ...
        {
            cmd.GetTemporaryRT(Shader.PropertyToID("_CameraDepthNormalsTexture"), descriptor, FilterMode.Point);
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, new ProfilingSampler(m_ProfilerTag)))
            {
                ...
                cmd.SetGlobalTexture("_CameraDepthNormalsTexture", Shader.PropertyToID("_CameraDepthNormalsTexture"));
            }
        ...
        public override void FrameCleanup(CommandBuffer cmd)
        {
            ...
            {
                cmd.ReleaseTemporaryRT(Shader.PropertyToID("_CameraDepthNormalsTexture"));
